function error = Max_error(K,N,x,D,lambda,R,v,upwind)
% function error = L2_error(K,N,x,D,lambda,R,v,upwind)
% Purpose : Compute Max error for the ADR equation using DG-FEM on multiple
%domains
FinalTime = 0.1;
x1 = -0.2;
x2 = -x1;
